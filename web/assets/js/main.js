(function(window, document, $, undefined) {
    ...
    var axilInit = {
        ...
        methods: function(e) {
            ...
            axilInit.campaignCountdown('.campaign-countdown', '2024/10/10');
            axilInit.countdownInit('.poster-countdown', '2024/10/10');
            axilInit.countdownInit('.sale-countdown', '2024/10/10');
