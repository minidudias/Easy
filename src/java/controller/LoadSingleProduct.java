    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (Validations.isInteger(productId)) {
                ...
                Criteria criteria1 = session.createCriteria(Product_Type.class);
                criteria1.add(Restrictions.eq("category",  product.getModel().getCategory() ));
                List<Product_Type> modelList = criteria1.list();
                ...
                response_DTO.setContent("Unable to find the requested product");
            }
        } catch (Exception e) {
            e.printStackTrace();
